...
| 5 | Celownik — osiem miast ze współrzędnymi, liczbą polskich studentów, źródłami i punktami SVG, budowa |
...
Uwaga o celowniku: pozycje miast na tarczy są stylizowane, nie kartograficzne — tabela
na str. 5 podaje wprost punkty `x, y`, przy odtwarzaniu przepisuje się je, a nie liczy.
Etykiety pokazują liczbę polskich studentów, nie dystans. Cztery kraje z jednym miastem
na celowniku (Szwecja, Dania, Szwajcaria, Hiszpania) mają liczbę wprost z Eurostatu
(`educ_uoe_mobs02`, 2024). Niderlandy i UK biorą najlepsze źródło krajowe (Nuffic,
HESA/Jisc 2024/25), bo Eurostat przestał je tak raportować po 2019. Oxford, Londyn,
Delft i Mediolan dodatkowo dzielą krajową liczbę wagą = studenci zagraniczni tej uczelni
÷ studenci zagraniczni całego kraju — to iloczyn dwóch źródeł, nie pomiar. Oxford
i Mediolan wyszły na tyle cienkie (≈40, ≈30), że są celowo zaokrąglone grubo („ok. 40",
„ok. 30"), żeby nie udawały precyzji, której nie mają. Pełne wagi i źródła są w tabeli
i przypisie na str. 5.
